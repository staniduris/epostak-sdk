...
const checks = [
  ...
  ["typescript/src/types.ts", "documentType?: DocType"],
  ["typescript/src/types.ts", "supplierPeppolId?: string"],
  ["typescript/src/types.ts", "precedingInvoiceRef?: string"],
  ...
  ["python/src/epostak/types.py", "documentType: str"],
  ["python/src/epostak/types.py", "supplierPeppolId: str"],
  ["python/src/epostak/types.py", "precedingInvoiceRef: str"],
  ...
  ["dotnet/src/EPostak/Models/Documents.cs", "JsonPropertyName(\"documentType\")"],
  ["dotnet/src/EPostak/Models/Documents.cs", "JsonPropertyName(\"supplierPeppolId\")"],
  ["dotnet/src/EPostak/Models/Documents.cs", "JsonPropertyName(\"precedingInvoiceRef\")"],
  ...
  ["java/src/main/java/sk/epostak/sdk/models/SendDocumentRequest.java", "SerializedName(\"documentType\")"],
  ["java/src/main/java/sk/epostak/sdk/models/SendDocumentRequest.java", "SerializedName(\"supplierPeppolId\")"],
  ["java/src/main/java/sk/epostak/sdk/models/SendDocumentRequest.java", "SerializedName(\"precedingInvoiceRef\")"],
  ...
  ["php/README.md", "'documentType' => 'self_billing'"],
  ["php/README.md", "'prepayments' => ["],
  ["ruby/README.md", "documentType: \"self_billing\""],
  ["ruby/README.md", "prepayments: ["],
