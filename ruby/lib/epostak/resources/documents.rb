...
module EPostak
  module Resources
    ...
    class Documents
      ...
      # IČ DPH, Postal Address, Legal Entity name) to the authenticated
      # firm. Caller-supplied values in
      # +cac:AccountingSupplierParty/cac:Party+ are silently overwritten
      # before forwarding to Peppol. The Peppol +EndpointID+ is the only
